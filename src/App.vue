  ...
  <div :data="rigeman" id="app">
    <v-touch
      ...
      <transition
        ...
        :name="rigeman"
        :mode="rigeman === 'slideInRight' ? 'in-out' : ''">
...
export default {
  ...
  methods: {
    ...
    onSwipeRight () {
      const fade = ['manager', 'teacher', 'home', 'news', 'my', 'login', 'editMsg', 'selectTeacher', 'details']
...
// 题干样式
.image{
  background: url('./assets/images/public/mediaico_s.png') no-repeat scroll -36px 0 rgba(0, 0, 0, 0);
  height: calc(18px/2);
  vertical-align: 1px;
  width: calc(18px/2);
  margin: 0 calc(2px/2);
...
.video{
  background: url('./assets/images/public/mediaico_s.png') no-repeat scroll -18px 0 rgba(0, 0, 0, 0);
  height: calc(18px/2);
  vertical-align: 1px;
  width: calc(18px/2);
  margin: 0 calc(2px/2);
...
.audio {
  background: url('./assets/images/public/mediaico_s.png') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
  height: calc(18px/2);
  vertical-align: 1px;
  width: calc(18px/2);
  margin: 0 calc(2px/2);
