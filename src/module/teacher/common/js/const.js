export const Tabs = [{
  name: '教学',
  imgSelect: require('@/assets/_images/teacher/tabs_select_1.png'),
  imgNormal: require('@/assets/_images/teacher/tabs_normal_1.png'),
  path: 'tHome'
}, {
  name: '消息',
  imgSelect: require('@/assets/_images/teacher/tabs_select_2.png'),
  imgNormal: require('@/assets/_images/teacher/tabs_normal_2.png'),
  path: 'tNews'
}, {
  name: '我的',
  imgSelect: require('@/assets/_images/teacher/tabs_select_3.png'),
  imgNormal: require('@/assets/_images/teacher/tabs_normal_3.png'),
  path: 'tMy'
}]
export const Slider = [
  require('@/assets/_images/teacher/banner1.png')
]
export const Switches = [{
  name: '作业托管',
  imgUrl: require('@/assets/_images/teacher/teacher_home1.png'),
...
export const StudentDetails = {
  state: 0,
  photo: require('@/assets/_images/public/audio.jpg'),
  name: '照明',
  user: 'e123456',
  classes: ['作业晚托1班', '作业晚托1班', '作业晚托1班', '作业晚托1班', '作业晚托1班', '作业晚托1班'],
  subject: [{
    name: '作业托管课程a',
    time: '2018.1.1-2018.2.2'
  }, {
    name: '作业托管课程a',
    time: '2018.1.1-2018.2.2'
  }],
...
export const teacherDetails = {
  ...
  qualifications: '本科',
  professional: '英语',
  certificate: require('@/assets/_images/public/audio.jpg'),
  subject: '英语',
  resume: '水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水水',
  email: '724361818@qq.com',
  address: '中和镇红树湾73-11'
}
...
export const schoolHistory = ['成都第一中学', '成都第二中学', '成都第三中学', '成都第一中学', '成都第二中学', '成都第三中学', '成都第一中学', '成都第二中学', '成都第三中学', '成都第一中学', '成都第二中学', '成都第三中学']
...
export const political = ['党员', '团员', '群众']
export const census = [
  '北京市',
  '天津市',
  '河北省',
...
export const qualifications = ['博士', '硕士', '本科', '专科', '高中', '其他']
