  ...
  <div class="cube-page cube-view button-view">
    ...
    <header class="header">
      ...
      <h1>
        ...
        <div class="voiceImageDiv" @click="clickVoiceShow" v-if="audioArray.length === 0">
          <img class="voiceImage" src="@/assets/images/batchEvaluate/voicePng.png" alt="">
        </div>
      </h1>
    </header>

    <!-- 录音播放 -->
    <div class="comment" v-show="audioArray.length > 0">
    ...
    <div class="contentToolBar">
      ...
      <div class="editTemplate" @click="goEditComments">编辑模板</div>
    ...
    <van-popup v-model="showVoicePopup" position="bottom" :overlay="true" @click-overlay="clickOverlay">
      <div class="van-picker">
        ...
        <div class="van-picker__columns voiceContainerDiv">
          <div class="van-picker-column voiceContainer">
...
export default {
  ...
  mounted: function() {
    ...
    self.chooseBatchEvaluateStudentsArray =
      self.$store.state.batchEvaluate.chooseBatchEvaluateStudentsArray;
    self.homeworkOneListInfoObj =
      self.$store.state.homeworkDetail.homeworkInfo;
  ...
  methods: {
    ...
    playAndPauseAudio(url, e) {
      url =
        url.indexOf("http") > -1
          ? url
          : this.$store.getters["runEnv/old"] + url;
      // alert(e)
...
.comment {
  ...
  .audio-preview .comment_audio {
    background: url("../../../assets/images/comments/audio_start.png") no-repeat
      center/100%;
  }
  .audio-preview.play .comment_audio {
    background: url("../../../assets/images/comments/audio_play.gif") no-repeat
      center/100%;
  }
  .audio-preview.end .comment_audio {
    background: url("../../../assets/images/comments/audio_end.png") no-repeat
      center/100%;
  }
