...
import StudentMp3Player from './assets/js/StudentMp3Player'
...
// console.log("%c master分支的打包时间: 0614-11:26", "background: #5AFFFD; color: #00f;");

StudentMp3Player.install(Vue)

// import Keyboard from '@anoah/keyboard'

console.log('%c version:2.0', 'color: red');
